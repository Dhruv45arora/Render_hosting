...
const ROUTES = [
  { code: 'MSR', name: 'Mussoorie', km: '34', time: '1h 15m' },
  { code: 'RSK', name: 'Rishikesh', km: '43', time: '1h 05m' },
  { code: 'HDW', name: 'Haridwar', km: '52', time: '1h 20m' },
  { code: 'CHD', name: 'Char Dham', km: '210+', time: 'Multi-day' },
];
        ...
        <header className={`rd-header ${scrolled ? 'is-scrolled' : ''}`}>
          <nav className="rd-nav container">
            ...
            <ul className="rd-nav-links">
              ...
              <li><button onClick={() => scrollTo('fleet')}>Fleet</button></li>
          ...
          {mobileMenuOpen && (
            <div className="rd-mobile-menu">
              ...
              <button onClick={() => scrollTo('fleet')}>Fleet</button>
        ...
        <section id="top" className="rd-hero">
          ...
          <div className="rd-hero-inner container">
            ...
            <div className="rd-board">
              ...
              {ROUTES.map((r) => (
                <div className="rd-board-row" key={r.code}>
        ...
        <section id="routes" className="rd-section">
          <div className="container">
            ...
            <div className="rd-mile-grid">
              {ROUTES.map((r, i) => (
                <div className="rd-mile-card rd-reveal" key={r.code} style={{ transitionDelay: `${i * 80}ms` }}>
